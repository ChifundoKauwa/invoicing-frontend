                ...
                <div className="space-y-4">
                  <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                    <p className="text-blue-400 text-sm">
                      <span className="font-semibold">Note:</span> Invoice number will be automatically generated by the system
                    </p>
                  </div>
                  <div>
              ...
              <div className="backdrop-blur-sm border-2 border-primary/30 rounded-xl p-8 shadow-lg shadow-primary/10">
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-lg font-semibold text-primary">Auto-Generated</p>
                  </div>
                </div>
